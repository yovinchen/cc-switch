...
pub(crate) use crate::proxy_core::api::auth::{
    ...
    compare_managed_auth_account_order, copilot_oauth_poll_error_kind,
    copilot_token_is_expiring_soon, ensure_managed_auth_provider,
    ...
    ManagedAuthStatus, CODEX_OAUTH_AUTH_PROVIDER, GITHUB_COPILOT_AUTH_PROVIDER,
};
pub(crate) use crate::proxy_core::api::config::{
...
pub(crate) fn forwarder_is_github_copilot_upstream(provider: &Provider, base_url: &str) -> bool {

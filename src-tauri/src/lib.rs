...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Proxy channel (中转站) management
            commands::list_proxy_channels,
            commands::create_proxy_channel,
            commands::get_proxy_channel,
            commands::update_proxy_channel,
            commands::delete_proxy_channel,
            commands::list_proxy_channel_models,
            commands::replace_proxy_channel_models,
            commands::list_proxy_channel_keys,
            commands::upsert_proxy_channel_key,
            commands::update_proxy_channel_key,
            commands::delete_proxy_channel_key,
            commands::test_proxy_channel,
            commands::list_proxy_app_channels,
            commands::get_current_proxy_route,
            commands::list_proxy_route_groups,
            commands::preview_proxy_channel_migration,
            commands::materialize_proxy_channel_migration,
            commands::resolve_proxy_route,
            commands::get_proxy_channel_breaker_stats,
            commands::reset_proxy_channel_breaker,
            // Usage statistics

use super::{error::ProxyError, error_mapper::claude_desktop_gateway_auth_error_to_proxy_error};
use crate::proxy_core_adapter::{validate_claude_desktop_gateway_bearer_header, ProxyState};

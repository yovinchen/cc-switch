...
use crate::proxy_core_adapter::{
    ...
    AppChannelListQuery, AppChannelManagementRequest, AppChannelResponse, AppKind,
    AppListRequest, AppListResponse, AppModelCatalogRequest,
    ...
    ProxyChannelWriteRequest, ProxyRuntimeStatus, ProxyState,

...
use crate::proxy_core_adapter::{
    ...
    AuthProfileRef, AuthProvider, CcSwitchProxyRuntime, ChannelAttemptResult, ChannelQuery,
    ChannelSpec, GeminiShadowStore, ProviderSpec, ProxyCoreEvent, ProxyRequest, ProxyServices,
    RoutePlan,
};
#[cfg(test)]

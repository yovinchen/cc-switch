...
pub mod ports {
    ...
    pub use crate::ports::{
        ...
        ClaudeEnvCredentials, OpenClawCredentialParts, OpenCodeCredentialIssue,
        OpenCodeCredentialParts, ProviderLiveSyncScope,
        ...
        should_skip_provider_legacy_common_config_migration, LiveTokenProviderSettingsIssue,
        LocalizedErrorSpec, CLAUDE_TAKEOVER_TOKEN_ENV_KEYS,

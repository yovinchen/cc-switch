...
pub mod management {
    ...
    pub use crate::ports::{
        ...
        should_retry_channel_reachability_failure, DEFAULT_CHANNEL_KEY_FAILURE_COOLDOWN_MS,
        stream_check_failed_result, stream_check_failed_result_with_retry_count,
        stream_check_result_from_probe_result,
        AppChannelListQuery, AppChannelListResponse, AppChannelResponse,
        AppChannelRouteResponse, AppListResponse, AppModelListQuery, AppSummary,
...
pub mod routing {
    ...
    pub use crate::domain::{
        ...
        auth_channel_spec_from_attempt, channel_status_after_health_attempt,
        channel_status_after_health_reset, default_auth_interface_for_app_kind,
        effective_channel_health_failure_threshold, effective_channel_key_failure_cooldown_ms,
        effective_forward_max_attempts_for_channel, health_policy_auto_disable_enabled,
        health_policy_failure_threshold, health_policy_key_failure_cooldown_ms,
...
pub mod prelude {
    pub use bytes::Bytes;
    pub use futures::{future::BoxFuture, Stream};
    ...
    pub use super::domain::{
        ...
        effective_channel_health_failure_threshold, effective_forward_max_attempts_for_channel,
    ...
    pub use super::management::{
        ...
        AppSummaryInput, channel_key_record_from_input,
        channel_key_runtime_candidate_from_input, channel_key_runtime_candidate_from_parts,
        channel_key_runtime_round_robin_cursor_key, channel_model_record_from_input,
        channel_health_update_from_input, channel_record_from_input,
        ...
        ChannelHealthResetResponse, ChannelHealthResetSource, ChannelHealthUpdate,
        ChannelHealthUpdateInput, ChannelKeyDeleteResponse,
        ChannelKeyDeleteSource, ChannelKeyPathRequest, ChannelKeyRecord, ChannelKeyRecordInput,
        ChannelKeyRecordResponse, ChannelKeyRecordSource, ChannelKeysResponse, ChannelKeysSource,
        ChannelListQuery, ChannelListPlan, ChannelListRequest, ChannelListResponse, ChannelListSource,
        ...
        ChannelKeyRuntimeLookupInput, ChannelKeyRuntimeSelectionInput,
        ChannelKeyRuntimeSelectionPolicy, ChannelKeyRuntimeSelectionStrategy,
        ...
        effective_channel_key_runtime_selection_policy,
        health_policy_channel_key_selection_strategy,
        provider_health_update_from_input,
        ...
        select_enabled_channel_key_runtime_candidate,
        select_enabled_channel_key_runtime_candidate_with_failure_cooldown,
        CHANNEL_HEALTH_UNKNOWN_STATUS, DEFAULT_CHANNEL_KEY_FAILURE_COOLDOWN_MS,
        auto_failover_toggle_plan_from_sources, reset_circuit_breaker_switchback_target_from_sources,
        stream_check_proxy_target_ids_from_sources,
        AutoFailoverTogglePlanOutcome,
        HealthCheckRequest, HealthCheckResponse, HealthCheckSource, ManagementAppPathRequest,
        ProviderListResponse, ProviderListSource,
        ProviderHealthUpdate, ProviderHealthUpdateInput, ProviderSummary, ProviderSummaryInput,
...
mod tests {
    ...
    #[test]
    fn prelude_exposes_claude_transform_contracts() {
        use prelude::*;
        ...
        let transformed = claude_request_transform_for_api_format(
            anthropic_body,
            "openai_chat",
        ...
        let request_output: ClaudeApiFormatRequestTransformOutput = transformed;
        assert_eq!(request_output.request["prompt_cache_key"], "cache-a");

        let response_output: ClaudeApiFormatResponseTransformOutput =
            claude_response_to_anthropic_message_for_api_format(
                &json!({
                    "id": "chatcmpl_1",
                    "model": "relay-chat",
        ...
        assert_eq!(response_output.response["content"][0]["text"], "hi");
        ...
        let _sse_context = ClaudeApiFormatSseTransformContext {
            shadow_store: None,
            provider_id: None,
            session_id: None,
        ...
        let _bytes = Bytes::from_static(b"data: [DONE]\n\n");
    }

...
pub mod prelude {
    ...
    pub use super::management::{
        ...
        AppSummaryInput, channel_model_record_from_input, ChannelBreakerStatsResponse,
        ChannelCreateRequest, ChannelCreateSource, ChannelDeleteResponse, ChannelDeleteSource,
        ...
        ChannelListPlan, ChannelListRequest, ChannelListResponse, ChannelListSource,
        ChannelMigrationMaterializeResponse, ChannelMigrationPreviewResponse,
        ChannelModelRecord, ChannelModelRecordInput, ChannelModelsResponse, ChannelModelsSource,
        ChannelPathRequest, ChannelReachabilityResult, ChannelRecord,

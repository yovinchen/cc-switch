...
pub mod prelude {
    ...
    pub use super::management::{
        ...
        AppSummaryInput, ChannelBreakerStatsResponse, ChannelCreateRequest, ChannelCreateSource,
        ChannelDeleteResponse, ChannelDeleteSource, ChannelHealthResetResponse, ChannelKeyDeleteResponse,
        ...
        ChannelModelRecord, ChannelModelsResponse, ChannelPathRequest, ChannelReachabilityResult, ChannelRecord,

...
pub mod prelude {
    ...
    pub use super::management::{
        ...
        ChannelBreakerStatsResponse, ChannelCreateRequest, ChannelCreateSource,
        ChannelDeleteResponse, ChannelDeleteSource, ChannelHealthResetResponse,
        ChannelKeyDeleteResponse, ChannelKeyDeleteSource, ChannelKeyPathRequest, ChannelKeyRecord,
        ChannelKeyRecordInput, ChannelKeyRecordResponse, ChannelKeyRecordSource,
        ChannelKeysResponse, ChannelKeysSource, ChannelListQuery, ChannelListPlan,
        ...
        ChannelReachabilityResult, ChannelRecord,

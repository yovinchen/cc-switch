...
pub mod management {
    ...
    pub use crate::ports::{
        ...
        channel_record_from_input, channel_test_provider_not_found_error, plan_channel_test,
...
pub mod prelude {
    ...
    pub use super::management::{
        ...
        channel_reachability_probe_error, channel_test_provider_not_found_error,
